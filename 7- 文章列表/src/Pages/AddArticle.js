...
function AddArticle (){
    ...
    // useEffect 页面加载时执行  第二个参数数组 空表示执行一次
    useEffect(()=>{
        getTypes()
    },[])
             ...
             <Row gutter={5}>
                 <Col span={18}>
                    <Row gutter={10}>
                        ...
                        <Col span={4}>
                            &nbsp;
                            <Select defaultValue={selectedType} size='large' onChange={value=>{setArticleId(value)}}>
                                {
                     ...
                     <Row >
                         ...
                         <Col span={12}>
                              <div className='date-select'>
                                  <DatePicker onChange={(date,dateString)=>{setShowDate(dateString)}} placeholder='发布日期' size='large' ></DatePicker>
                              </div>
                         </Col>
                     </Row>
                 </Col>
